...
/// Loads a test WASM module and run all test functions annotated by [`webassembly-test`].
///
...
impl<'a> Test<'a> {
    ...
    /// Runs an test function exported from the WASM module and report its result.
    ///
