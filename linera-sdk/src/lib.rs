...
pub trait Contract: Sized {
    ...
    ///
    /// Cross-application calls are a way for applications to interact inside a micro-chain. An
    /// application can call any other application available on the micro-chain the execution is
    /// taking place on.
    ///
    ...
    /// - an [`ExecutionResult`] with effects to be sent to this application on other micro-chains
    ...
    ///     micro-chains and channel subscription and unsubscription requests.
