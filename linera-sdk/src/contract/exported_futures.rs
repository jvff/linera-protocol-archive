...
impl<Application> ContractState for SimpleStateStorage<Application>
where
...
impl<Application> ContractState for ViewStateStorage<Application>
where
...
where
    ...
    Application::Storage: ContractState,
{
