...
#[cfg(with_testing)]
use super::mock_system_api as mock_wit;
use crate::{
...
impl WitInterface {
    ...
    fn contains_key_new(&self, key: &[u8]) -> u32 {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::contains_key_new(key),
        }
    }
    ...
    fn contains_key_wait(&self, promise: u32) -> bool {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::contains_key_wait(promise),
        }
    }
    ...
    fn read_multi_values_bytes_new(&self, keys: &[Vec<u8>]) -> u32 {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::read_multi_values_bytes_new(keys),
        }
    }
    ...
    fn read_multi_values_bytes_wait(&self, promise: u32) -> Vec<Option<Vec<u8>>> {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::read_multi_values_bytes_wait(promise),
        }
    }
    ...
    fn read_value_bytes_new(&self, key: &[u8]) -> u32 {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::read_value_bytes_new(key),
        }
    }
    ...
    fn read_value_bytes_wait(&self, promise: u32) -> Option<Vec<u8>> {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::read_value_bytes_wait(promise),
        }
    }
    ...
    fn find_keys_new(&self, key_prefix: &[u8]) -> u32 {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::find_keys_new(key_prefix),
        }
    }
    ...
    fn find_keys_wait(&self, promise: u32) -> Vec<Vec<u8>> {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::find_keys_wait(promise),
        }
    }
    ...
    fn find_key_values_new(&self, key_prefix: &[u8]) -> u32 {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::find_key_values_new(key_prefix),
        }
    }
    ...
    fn find_key_values_wait(&self, promise: u32) -> Vec<(Vec<u8>, Vec<u8>)> {
        match self {
            ...
            #[cfg(with_testing)]
            WitInterface::Mock { .. } => mock_wit::find_key_values_wait(promise),
        }
    }
