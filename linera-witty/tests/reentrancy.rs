...
{
    let instance = factory.load_test_module::<ExportedGetters<InstanceFactory::Caller<'static>>>(
        "reentrancy",
        "getters",
    );
...
{
    let instance = factory.load_test_module::<ExportedSetters<InstanceFactory::Caller<'static>>>(
        "reentrancy",
        "setters",
    );
    ...
    ExportedOperations<InstanceFactory::Caller<'static>>: ExportTo<InstanceFactory::Builder>,
{
    let instance = factory
        .load_test_module::<ExportedOperations<InstanceFactory::Caller<'static>>>(
            "reentrancy",
            "operations",
        );
