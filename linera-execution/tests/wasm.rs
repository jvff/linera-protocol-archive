...
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::Wasmer, 38_654, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::WasmerWithSanitizer, 39_022, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::Wasmtime, 39_022, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::WasmtimeWithSanitizer, 39_022, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
