...
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::Wasmer, 27_254, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::WasmerWithSanitizer, 27_598, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::Wasmtime, 27_598, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::WasmtimeWithSanitizer, 27_598, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
