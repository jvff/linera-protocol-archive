...
#[cfg_attr(with_wasmer, test_case(WasmRuntime::Wasmer, 39_621, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(with_wasmer, test_case(WasmRuntime::WasmerWithSanitizer, 39_973, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::Wasmtime, 39_973, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(with_wasmtime, test_case(WasmRuntime::WasmtimeWithSanitizer, 39_973, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
