...
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::Wasmer, 84_193, ExecutionRuntimeConfig::Synchronous; "wasmer"))]
#[cfg_attr(feature = "wasmer", test_case(WasmRuntime::WasmerWithSanitizer, 85_498, ExecutionRuntimeConfig::Synchronous; "wasmer_with_sanitizer"))]
#[cfg_attr(feature = "wasmtime", test_case(WasmRuntime::Wasmtime, 85_498, ExecutionRuntimeConfig::Synchronous; "wasmtime"))]
#[cfg_attr(feature = "wasmtime", test_case(WasmRuntime::WasmtimeWithSanitizer, 85_498, ExecutionRuntimeConfig::Synchronous; "wasmtime_with_sanitizer"))]
