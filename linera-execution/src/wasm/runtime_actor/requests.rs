...
use super::responses::{SyncOrAsyncResponse, SyncResponse};
...
pub enum ContractRequest {
    ...
    TryCallApplication {
        ...
        response: Arc<SyncResponse<CallResult>>,
    },
