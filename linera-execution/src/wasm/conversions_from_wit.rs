...
impl From<writable_system::ApplicationId> for ApplicationId {
    fn from(guest: writable_system::ApplicationId) -> Self {
        match guest {
            writable_system::ApplicationId::System => ApplicationId::System,
            writable_system::ApplicationId::User(user_application_id) => user_application_id.into(),
        }
    }
}

impl From<writable_system::UserApplicationId> for ApplicationId {
    fn from(guest: writable_system::UserApplicationId) -> Self {
        ApplicationId::User {
